...
%% 辅助函数
    ...
    % 区名
    stationCell = strsplit(key{1,4},'.');
    IniFileInfo.siteName = stationCell{1};
    % 期数
    campaignCell = strsplit(key{2,4},'.');
    IniFileInfo.campaign = campaignCell{1};
    %时空坐标
    ...
    IniFileInfo.pos = [IniFileInfo.lon IniFileInfo.lat IniFileInfo.time];
    %站名
